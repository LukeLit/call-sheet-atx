...
export function Platform() {
  return (
    <section id="platform" className="border-t border-ink/10">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {Icon ? (
                      <Icon
                        className={cn(
                          "h-4 w-4",
                          featured ? "text-amber" : "text-ink/50",
                        )}
                        strokeWidth={1.75}
                        aria-hidden
                      />
        ...
        <Reveal delay={0.2} className="mt-6">
          <div className="paper-grain shadow-sheet">
            ...
            <div className="space-y-4 px-5 py-5 text-ink">
              {platform.chat.map((line) => (
                <Chat key={line.text} who={line.who} text={line.text} />
              ))}
            </div>
          </div>
        </Reveal>
